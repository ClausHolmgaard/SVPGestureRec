...
def create_model(width, height, channels,
    ...
    pool1 = MaxPool2D(pool_size=pool_size, strides=pool_stride, padding='SAME', name="pool1")(fire1_1)

    fire2_1 = fl(name="fire2_1", input=pool1,   s1x1=48, e1x1=192, e3x3=192, regularizer=regularizer)
    ...
    pool2 = MaxPool2D(pool_size=pool_size, strides=pool_stride, padding='SAME', name="pool2")(fire2_4)
    ...
    pool3 = MaxPool2D(pool_size=pool_size, strides=pool_stride, padding='SAME', name="pool3")(fire3_4)
